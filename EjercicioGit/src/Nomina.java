...
public class Nomina implements InterfazCalcNomina {
	...
	private static final int PlusTrienio = 30;
	 ...
	 */
	@Override
	public double calcuNomina()
	{
		// Sueldo neto
		float sueldoNeto=sueldoBase;
		
		// Incrementamos la parte de trienios;
		sueldoNeto = sueldoNeto + (numTrienios*PlusTrienio);
	...
	public static void main(String[] args) {
		...
		InterfazCalcNomina ob = new Nomina(sueldoBase, trienios, 
						       jefe=='S'?true:false, 
						       casado=='S'?true:false,
						       numHijos);
	
		// Calcular la nómina del trabajador
		System.out.println("Este trabajador cobra "+ob.calcuNomina()+ " €");
